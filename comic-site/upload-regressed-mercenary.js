// Uploads "The Regressed Mercenary's Machinations" to the live site (R2 + Supabase)
...
const SOURCE_DIR = 'D:/The Regressed Mercenary Has a Plan';
const COVER_FILE = 'ffcw7vlbj1se1.jpeg';
...
// Handles: "[Ch-001] The Regressed Mercenary's [@Manga_Cruise].pdf"
...
async function main() {
  ...
  const coverUrl = await uploadFile(
    coverPath,
    `covers/regressed-mercenary-cover-${Date.now()}.jpeg`,
    'image/jpeg'
  );
